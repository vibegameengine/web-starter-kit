...
export class PoissonDenoisePass extends Pass {
	...
	constructor(camera, textures, options = defaultPoissonBlurOptions) {
		...
		this.renderTargetA = new WebGLRenderTarget(1, 1, { count: textureCount, ...renderTargetOptions })
		this.renderTargetB = new WebGLRenderTarget(1, 1, { count: textureCount, ...renderTargetOptions })
