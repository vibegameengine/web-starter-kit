...
export class VelocityDepthNormalPass extends Pass {
	...
	setSize(width, height) {
		...
		this.lastVelocityTexture = new FramebufferTexture(width, height)
		this.lastVelocityTexture.format = this.renderTarget.texture.format
		this.lastVelocityTexture.type = FloatType
		this.lastVelocityTexture.colorSpace = this.renderTarget.texture.colorSpace
		this.lastVelocityTexture.flipY = false
