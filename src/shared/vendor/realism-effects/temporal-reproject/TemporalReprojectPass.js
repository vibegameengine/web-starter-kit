...
import { jitter, unjitter } from "../taa/TAAUtils"
...
export class TemporalReprojectPass extends Pass {
	...
	setSize(width, height) {
		...
		this.framebufferTexture = new FramebufferTexture(width, height)
		this.framebufferTexture.format = inputTexture.format
		this.framebufferTexture.type = inputTexture.type
		this.framebufferTexture.colorSpace = inputTexture.colorSpace
		this.framebufferTexture.flipY = false
